...
public class RomiDrivetrain extends SubsystemBase {
    ...
    public void setSpeeds(double leftMetersPerSecond, double rightMetersPerSecond) {
        m_leftMotor.set(leftMetersPerSecond);
        m_rightMotor.set(rightMetersPerSecond);
    }
    ...
    public void periodic() {
        ...
        m_odometry.update(Rotation2d.fromDegrees(-getGyroAngle()), getLeftDistanceMeters(), getRightDistanceMeters());
    }
